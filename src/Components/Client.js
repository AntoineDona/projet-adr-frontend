...
export default function Client() {
  ...
  function commandList(articlestatus) {
    let commands_array = false ? commands.slice(0).reverse() : commands;
    return (
      commands_array.map((command) => {
        ...
        if (mappingOfCommand.some(e => typeof (e) === 'object') && todisplay1 && todisplay2) { //si un objet est présent dans l'array, cad il y a un article
